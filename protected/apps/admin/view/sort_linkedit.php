...
<div class="list_head_m">
         ...
         <table width="100%" border="0" cellpadding="0" cellspacing="1"   class="all_cont">
          ...
          <tr>
            ...
            <td align="left">
            <?php if($info['extendid']==1) { ?>
             <input name="ifout" type="radio" value="1" checked>是&nbsp;<input name="ifout" type="radio" value="0">否
			<?php } else{ ?>
               <input name="ifout" type="radio" value="1" >是&nbsp;<input name="ifout" type="radio" value="0" checked>否
            <?php } ?>
