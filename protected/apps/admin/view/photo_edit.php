	 ...
	 $('#file_upload').uploadify({
      ...
      'buttonImage' : '__PUBLIC__/uploadify/downbut.jpg',
          ...
          'onUploadStart': function (file) {
             $("#file_upload").uploadify("settings", "formData", {'ttype':getval('thumbtype'),width:getval('thumbwidth'),height:getval('thumbheight')});  
           },
        ...
        <form  action="{url('photo/edit',array('id'=>$info['id']))}" method="post" id="info" onSubmit="return check_form(document.add);">
         <table class="all_cont" width="100%" border="0" cellpadding="5" cellspacing="1"   >
          ...
          <tr>
            ...
            <td width="50%">     
               <div style="float:left; width:50%"><input type="file" name="file_upload" id="file_upload" /></div>
               <div style="float:left; width:10%"><a id="up_img" class="btn" href="javaScript:$('#file_upload').uploadify('upload','*');">上传</a></div>
               <div style="float:left; width:40%; ">
               缩略图：<select name="thumbtype" id="thumbtype">
                        <option value='1' selected>按配置剪切</option>
            ...
            <td class="inputhelp">支持批量上传图片<br><a href="{url('set/index')}">设置缩略图默认长宽</a></td>
         </tr>
          <tr>
