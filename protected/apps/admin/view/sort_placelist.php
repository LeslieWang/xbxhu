...
<div class="list_head_m">        
           ...
           <div class="list_head_mr"><a href="{url('sort/placeadd')}" class="add">新增</a></div>                           
        </div>
          ...
          <?php 
                 if(!empty($list)){
                      foreach($list as $vo){
                          ...
                          $cont.='<td align="center"><a href="'.url('sort/placeedit',array('id'=>$vo['id'])).'" class="edt">编辑</a><a href="'.url('sort/placedel',array('id'=>$vo['id'])).'" class="edt" onClick="return confirm(\'删除后资讯和图集内容定位将不能选择该项~\')">删除</a></td></tr>';
                       }
                       echo $cont;
                     }
          ?>
